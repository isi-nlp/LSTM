...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_train_text', metavar='file', dest='input_train_text', help='input training text file. Required')
    parser.add_argument('--output_train_text', metavar='file', dest='output_train_text', help='output training text file. Required')
    ...
    parser.add_argument('--n_input_vocab', metavar='V', dest='n_input_vocab', type=int, help='number of input word types. Required')
    parser.add_argument('--n_output_vocab', metavar='V', dest='n_output_vocab', type=int, help='number of output word types. Required')
    parser.add_argument('--input_words_file', metavar='file', dest='input_words_file', help='make input vocabulary. Required')
    parser.add_argument('--output_words_file', metavar='file', dest='output_words_file', help='make output vocabulary. Required')
